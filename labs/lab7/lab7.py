...
def simple_tests():
    ...
    logger.info("-----------------------------------------------------------\n")
    logger.info(f"| {results_1[0]} |    {results_1[1]:.6f}    |     {results_1[2]['funcalls']:02d}    |")
    logger.info("-----------------------------------------------------------\n")
    logger.info(f"| {results_2[0]} |    {results_2[1]:.6f}    |     {results_2[2]['funcalls']:02d}    |")
    logger.info("-----------------------------------------------------------\n")
    logger.info(f"| {results_3[0]} |    {results_3[1]:.6f}    |     {results_3[2]['funcalls']:02d}    |")
    logger.info("-----------------------------------------------------------\n")
